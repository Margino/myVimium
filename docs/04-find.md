...
После того как нужный фрагмент текста выделен, его можно скопировать или отменить операцию.

| Команда | Действие |
|---------|----------|
| `y` | Скопировать (Yank) выделенный текст в буфер обмена и выйти из режима |
| <kbd>Esc</kbd> | Отменить выделение и полностью выйти из визуального режима |

**Особенности работы:**
* При нажатии `y` выделение автоматически пропадает, в углу экрана на долю секунды показывает уведомление *«Yanked»* (Скопировано) .
* Текст копируется в системный буфер обмена, его можно вставить в через стандартную комбинацию <kbd>Ctrl</kbd> + <kbd>V</kbd> (<kbd>Cmd</kbd> + <kbd>V</kbd> на Mac).
